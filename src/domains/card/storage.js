...
//
// 键名空间划分:
//   stmt:<accountKey>             该账户"最近一期"实测记录  (accountKey = 五段身份的 crc32 短哈希,
//                                  与日历/闹钟 uid 同源 —— 见 event-builder.js 的冻结声明)(给日历生成用，只存最新，选Y方案:不外推)
//   hist:<accountKey>:<ISO时间>   历史流水(自动记账副产品，给你以后做账单规律分析用，只追加不覆盖)
